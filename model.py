...
class Net1(nn.Module):
    def __init__(self):
        ...
        # -----------------------------------------------------------
        super(Net1, self).__init__()  # Наследуемый родительским классом nn.Module
...
class Net3(nn.Module):
    def __init__(self):
        ...
        self.layer1 = nn.Sequential(nn.Conv2d(1, 45, kernel_size=5, stride=2),
                                    nn.ReLU(), nn.MaxPool2d(kernel_size=6, stride=4))
        # self.layer2 = nn.Sequential(nn.Conv2d(45, 45*2, kernel_size=5, stride=1, padding=2),
